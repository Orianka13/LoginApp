...
extension Hobby {
    static func getHobbies() -> [Hobby] {
        [Hobby(hobby: "DIY", description: "I like to make different things with my hands: scarves, hats, brooches, wreaths, jewelry, etc. This is my antistress.", photo: "diy"),
